...
if (!function_exists('books_printing_after_setup_theme')) {
	...
	function books_printing_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'books-printing') {
			wp_redirect(admin_url('themes.php?page=books_printing_about'));
		}
